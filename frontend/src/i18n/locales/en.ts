...
export const en: typeof ro = {
  ...
  payments: {
    ...
    open: 'Instalments',
    backToVehicle: 'Back to the vehicle',
    intro: 'Your car-loan or leasing instalment and your CASCO instalment, with a reminder '
      + 'before each. Only the dates are kept, never the amounts.',
    none: 'No instalments recorded for this vehicle.',
    add: 'Add an instalment',
    save: 'Save the instalment',
    edit: 'Change',
    saveCorrection: 'Save the change',
    delete: 'Delete',
    confirmDelete: 'Delete this instalment? Its reminders will stop.',
    confirmDeleteYes: 'Yes, delete',
    cancel: 'Cancel',
    kind: {
      LOAN: 'Loan/leasing instalment',
      CASCO: 'CASCO instalment',
    },
    frequency: {
      MONTHLY: 'Monthly',
      QUARTERLY: 'Quarterly',
    ...
    fields: {
      kind: 'Type of instalment',
      firstDueDate: 'First instalment date',
      frequency: 'How often',
      endBy: 'Until',
      lastDueDate: 'Last instalment date',
      instalmentCount: 'Number of instalments',
      leads: 'Reminders',
    },
    endBy: {
      date: 'Until the last instalment date',
      count: 'A number of instalments',
    },
    lead: {
      days7: '7 days before',
      days3: '3 days before',
      day1: '1 day before',
      onTheDay: 'On the due date',
    },
    schedule: {
      one: '{{frequency}}, a single instalment, on {{first}}.',
      few: '{{frequency}}, {{count}} instalments, from {{first}} to {{last}}.',
      many: '{{frequency}}, {{count}} instalments, from {{first}} to {{last}}.',
    },
    next: 'Next instalment: {{date}} — {{number}} of {{count}}.',
    finished: 'All instalments have passed.',
    reminders: 'Reminders: {{leads}}.',
    due: {
      today: 'Today ({{date}}).',
      one: 'Tomorrow ({{date}}).',
      few: 'In {{days}} days ({{date}}).',
  ...
  validation: {
    ...
    instalmentCount: 'Between 1 and 120 instalments.',
  },
  errors: {
